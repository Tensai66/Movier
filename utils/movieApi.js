...
const fetchFavoriteMovies = (id) => {
  return fetch(`https://protected-bayou-72415.herokuapp.com/api/users/${id}/favorites`)
...
const fetchAddFavoriteMovie = (movie, id) => {
  return fetch('https://protected-bayou-72415.herokuapp.com/api/users/favorites/new', {
    method: 'POST',
    headers: {
...
const fetchRemoveFavoriteMovie = (movieId, userId) => {
  return fetch(`https://protected-bayou-72415.herokuapp.com/api/users/${userId}/favorites/${movieId}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json'
    },
...
const fetchCreateUser = (name, email, password) => {
  return fetch('https://protected-bayou-72415.herokuapp.com/api/users/new', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
const fetchSignInUser = (email, password) => {
  return fetch('https://protected-bayou-72415.herokuapp.com/api/users', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
